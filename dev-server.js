...
import {
  AiServer,
} from './packages/engine/servers/ai-server.js';
import {
  YoutubeServer,
} from './packages/engine/servers/youtube-server.js';
...
const SERVER_PORT = parseInt(process.env.PORT, 10) || 443;
...
// The multiplayer server is started in index.mjs.
/*
...
(async () => {
  ...
  app.all('*', async (req, res, next) => {
    ...
    if (req.headers.host === COMPILER_NAME) {
      console.log('route compiler request', req.url);
