...
export class HpManager {
  ...
  getDamagePhysicsMesh() {
    if (!this.damagePhysicsMesh) {
      ...
      this.damagePhysicsMesh = _makeDamagePhysicsMesh();
      this.damagePhysicsMesh.visible = false;
      this.add(this.damagePhysicsMesh);
      this.damagePhysicsMesh.updateMatrixWorld();
    }
    return this.damagePhysicsMesh;
  }
}
// const hpManager = {
//   makeHitTracker,
