...
export const getModelBones = object => {
  ...
  if (!Root) {
    ...
    Left_thumb2 = _getOptional(_findFinger(Left_wrist, /thumb3_end|thumb2_|handthumb3|thumb_distal|thumb02l|l_thumb3|thumb002l|ThumbDistal/i));
    Left_thumb1 = _ensureParent(Left_thumb2);
    Left_thumb0 = _ensureParent(Left_thumb1, Left_wrist);
    Left_indexFinger3 = _getOptional(_findFinger(Left_wrist, /index(?:finger)?3|index_distal|index02l|indexfinger3_l|index002l|IndexDistal/i));
    Left_indexFinger2 = _ensureParent(Left_indexFinger3);
    Left_indexFinger1 = _ensureParent(Left_indexFinger2, Left_wrist);
    Left_middleFinger3 = _getOptional(_findFinger(Left_wrist, /middle(?:finger)?3|middle_distal|middle02l|middlefinger3_l|middle002l|MiddleDistal/i));
    Left_middleFinger2 = _ensureParent(Left_middleFinger3);
    Left_middleFinger1 = _ensureParent(Left_middleFinger2, Left_wrist);
    Left_ringFinger3 = _getOptional(_findFinger(Left_wrist, /ring(?:finger)?3|ring_distal|ring02l|ringfinger3_l|ring002l|RingDistal/i));
    Left_ringFinger2 = _ensureParent(Left_ringFinger3);
    Left_ringFinger1 = _ensureParent(Left_ringFinger2, Left_wrist);
    Left_littleFinger3 = _getOptional(_findFinger(Left_wrist, /little(?:finger)?3|pinky3|little_distal|little02l|lifflefinger3_l|little002l|LittleDistal/i));
    ...
    Right_thumb2 = _getOptional(_findFinger(Right_wrist, /thumb3_end|thumb2_|handthumb3|thumb_distal|thumb02r|r_thumb3|thumb002r|ThumbDistal/i));
    Right_thumb1 = _ensureParent(Right_thumb2);
    Right_thumb0 = _ensureParent(Right_thumb1, Right_wrist);
    Right_indexFinger3 = _getOptional(_findFinger(Right_wrist, /index(?:finger)?3|index_distal|index02r|indexfinger3_r|index002r|IndexDistal/i));
    Right_indexFinger2 = _ensureParent(Right_indexFinger3);
    Right_indexFinger1 = _ensureParent(Right_indexFinger2, Right_wrist);
    Right_middleFinger3 = _getOptional(_findFinger(Right_wrist, /middle(?:finger)?3|middle_distal|middle02r|middlefinger3_r|middle002r|MiddleDistal/i));
    Right_middleFinger2 = _ensureParent(Right_middleFinger3);
    Right_middleFinger1 = _ensureParent(Right_middleFinger2, Right_wrist);
    Right_ringFinger3 = _getOptional(_findFinger(Right_wrist, /ring(?:finger)?3|ring_distal|ring02r|ringfinger3_r|ring002r|RingDistal/i));
    Right_ringFinger2 = _ensureParent(Right_ringFinger3);
    Right_ringFinger1 = _ensureParent(Right_ringFinger2, Right_wrist);
    Right_littleFinger3 = _getOptional(_findFinger(Right_wrist, /little(?:finger)?3|pinky3|little_distal|little02r|lifflefinger3_r|little002r|LittleDistal/i));
