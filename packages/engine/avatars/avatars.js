...
class Avatar {
  ...
  update(timestamp, timeDiff) {
    ...
    if (true && this === globalThis.localPlayer?.avatar) {
      ...
      // if (globalThis.domInfo.innerHTML.includes('Jump: --- SUCCESS')) {
        // console.log(globalThis.domInfo.innerHTML)
        // debugger
      // }
      ...
      */
      ...
      globalThis.domInfo.innerHTML += `<div style="display:;">grounded: --- ${globalThis.localPlayer?.characterPhysics.grounded}</div>`;
      ...
      globalThis.domInfo.innerHTML += `<div style="display:;">calcedVelocity: --- ${globalThis.logVector3(this.calcedVelocity)} - ${globalThis.logNum(this.calcedVelocity.length())}</div>`;
