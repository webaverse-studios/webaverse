...
export class JFAOutline {
    ...
    `, {
        ...
        this.outlinePass = outlinePass !== null && outlinePass !== undefined ? outlinePass : fullScreenPass_1.fullScreenPass(`
      uniform sampler2D tex;
    ...
    renderDistanceTex(renderer, targets, iResolution, outlineUniforms) {
        ...
        const distance = (_a = outlineUniforms === null || outlineUniforms === undefined ? undefined : outlineUniforms.threshHigh) !== null && _a !== undefined ? _a : Math.max(iResolution.x, iResolution.y);
